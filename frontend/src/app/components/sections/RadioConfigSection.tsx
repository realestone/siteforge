    ...
    <div className="space-y-4">
      <div className="grid grid-cols-2 gap-4">
        <div className="space-y-2">
          ...
          <Select
            value={tssrData.sectors > 0 ? tssrData.sectors.toString() : ""}
            onValueChange={(value) =>
              updateTSSRField("sectors", parseInt(value))
            }
          >
                  ...
                  <tr key={sector.id} className="border-b">
                    ...
                    <td className="py-2 px-2">
                      <Input
                        ...
                        onChange={(e) =>
                          updateSectorData(index, "antenna", e.target.value)
                        }
                        placeholder=""
