...
import { ChevronRight, CheckCircle2, AlertCircle, Circle, FileText, Camera, PenTool, Eye } from 'lucide-react';
...
import { AccessLogisticsSection } from './sections/AccessLogisticsSection';
import { PowerGroundingSection } from './sections/PowerGroundingSection';
...
export const LeftPanel: React.FC = () => {
  ...
  const sections: Section[] = [
    { id: 'site-identity', title: 'Site Identity', status: 'complete', component: SiteIdentitySection },
    { id: 'radio-config', title: 'Radio Configuration', status: 'complete', component: RadioConfigSection },
    { id: 'access-logistics', title: 'Access & Logistics', status: 'warning', component: AccessLogisticsSection },
    { id: 'building-info', title: 'Building Info', status: 'complete', component: BuildingInfoSection },
    { id: 'power-grounding', title: 'Power & Grounding', status: 'complete', component: PowerGroundingSection },
  ];
    ...
    <div className="flex h-full flex-col bg-gray-50">
      ...
      <div className="border-b bg-white px-2 py-2">
        <div className="flex gap-1">
          {(['form', 'photos', 'sketch', 'preview'] as PanelMode[]).map(modeType => (
            <button
              key={modeType}
      ...
      {mode === 'form' && (
        <>
          <div className="border-b bg-white px-4 py-3">
            <h2 className="text-sm font-semibold text-gray-900">TSSR Builder</h2>
          </div>
